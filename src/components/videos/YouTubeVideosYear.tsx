...
export default class TrendingByYear extends React.Component<IYouTubeVideosProps, IYouTubeVideosState> {
  ...
  async componentDidMount() {
    this.setState({
      videoItems: await this.dataParser.getVideoItemsByYear(this.props.year),
  ...
  public render(): React.ReactElement<{}> {
    ...
    return (
      <>
        ...
        <Label styles={styles.labelSubStyles}>{`${this.props.year} Views Videos`}</Label>
