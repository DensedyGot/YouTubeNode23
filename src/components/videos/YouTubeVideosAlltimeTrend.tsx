...
export default class YouTubeVideosAlltimeTrend extends React.Component<IYouTubeVideosProps, IYouTubeVideosState> {
  ...
  async componentDidMount() {
    this.setState({
      videoItems: await this.dataParser.getVideoItemsByAlltimeTrend(),
  ...
  public render(): React.ReactElement<{}> {
    ...
    return (
      <>
        ...
        <Label styles={styles.labelSubStyles}>{'All Time Trending Videos'}</Label>
