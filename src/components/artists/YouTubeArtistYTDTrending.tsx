...
export default class YouTubeArtistYTDTrending extends React.Component<IYouTubeVideosProps, IYouTubeArtistsState> {
  ...
  async componentDidMount() {
    this.setState({
      artistItems: await this.dataParser.getArtistItemsYTDTrendingInitials(),
  ...
  public render(): React.ReactElement<{}> {
    ...
    return (
      <>
        ...
        <Label styles={styles.labelSubStyles}>{'Past Year Trending by Artists'}</Label>
