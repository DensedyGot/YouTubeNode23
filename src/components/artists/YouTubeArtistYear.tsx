...
export default class YouTubeArtistYear extends React.Component<IYouTubeVideosProps, IYouTubeArtistsState> {
  ...
  async componentDidMount() {
    this.setState({
      artistItems: await this.dataParser.getArtistItemsByYearInitials(this.props.year),
  ...
  public render(): React.ReactElement<{}> {
    ...
    return (
      <>
        ...
        <Label styles={styles.labelSubStyles}>{`${this.props.year} Trending by Artists`}</Label>
